                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="ml-auto">
                            ...
                            <Nav.Link onClick={() => { handleLinkClick('ViewMyTrekk') }}>My Orders</Nav.Link>
                            ...
                            <Nav.Link className="ml" onClick={() => { handleLinkClick('ViewMyTrekk') }}><FontAwesomeIcon icon={faShoppingCart} /></Nav.Link>
