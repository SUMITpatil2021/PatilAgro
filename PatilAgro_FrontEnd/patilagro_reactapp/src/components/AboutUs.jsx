...
const AboutUs= () => {
  return (
    <div>
      ...
      <h3>Why Choose Patil Agro?</h3>
      <ul>
        <li><strong>Farm-Fresh Quality:</strong> We source our vegetables directly from trusted farmers who share our commitment to quality and sustainability.</li>
        <li><strong>Convenience:</strong> Shop from the comfort of your home and have your vegetables delivered right to your doorstep.</li>
        <li><strong>Sustainability:</strong> We support eco-friendly farming practices that protect the environment and promote biodiversity.</li>
        <li><strong>Community Support:</strong> By choosing Patil Agro, you are supporting local farmers and contributing to the growth of your community.</li>
      </ul>
